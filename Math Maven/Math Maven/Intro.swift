...
struct Intro: View {
    ...
    private let bgColors: [Color] = [
        Color(UIColor(resource: .CS_1)), Color(UIColor(resource: .CS_4)),
        Color(UIColor(resource: .CS_2)), Color(UIColor(resource: .CS_5)),
        Color(UIColor(resource: .CS_3)), Color(UIColor(resource: .CS_1)),
        Color(UIColor(resource: .CS_4)), Color(UIColor(resource: .CS_2)),
        Color(UIColor(resource: .CS_5)), Color(UIColor(resource: .CS_3))
    ]
    private let textAccent: [Color] = [
        Color(UIColor(resource: .CS_6)), Color(UIColor(resource: .CS_3)),
        Color(UIColor(resource: .CS_6)), Color(UIColor(resource: .CS_1)),
        Color(UIColor(resource: .CS_6)), Color(UIColor(resource: .CS_6)),
        Color(UIColor(resource: .CS_3)), Color(UIColor(resource: .CS_6)),
        Color(UIColor(resource: .CS_1)), Color(UIColor(resource: .CS_6))
    ]
            ...
            VStack{
                ...
                NavigationLink(destination: ContentView()) {
                    Text("View Sampling UI")
                        ...
                        .padding()
                        .background(Color(UIColor(resource: .CS_1)))
                        .cornerRadius(15)
                        .foregroundStyle(Color(UIColor(resource: .CS_5)))
                }
                .frame(width: 200, height: 20, alignment: .center)
                .padding()
    ...
    var body: some View{
        ScrollViewReader{ proxy in
            ScrollView{
                ...
                Text("In the whiteboard square, slowly draw and submit a 3 (easy to see). Look at the resulting Matrix.")
                    .font(.subheadline)
                    .frame(alignment: .leading)
                ...
                VStack{
                    ...
                    HStack{
                        ...
                        Button{
                            proxy.scrollTo("arrayDrawing", anchor: .bottom)
                        }label: {
                        ...
                        ScrollView(.vertical) {
                            ForEach(0..<Matrix.count, id: \.self) { row in
                                Text(Matrix[row].description.replacingOccurrences(of: "255", with: "⚫").replacingOccurrences(of: "0", with: "⚪"))
                                    ...
                                    .onAppear{
                                        proxy.scrollTo("\(Matrix.count/2)", anchor: .center)
                                    }
                                
                            }
                        }
                        .scrollIndicators(.visible)
//                         .defaultScrollAnchor(.center) // 17 or later
                        
                    }
                    .scrollIndicators(.visible)
                    .defaultScrollAnchor(.center) //17 or later
                    .clipShape(RoundedRectangle(cornerRadius: 15))
                    .shadow(color: Color(UIColor(resource: .CS_6)) ,radius: 1)
                    .id("arrayDrawing")
...
//            .defaultScrollAnchor(.top) // 17 or later
            .scrollIndicators(.visible)
            .frame(maxWidth: UIScreen.main.bounds.width - 50, alignment: .leading)
        }
    }
                ...
                if !tutorialCompleted{
                    Button{
                        ...
                        Text("Begin")
                            ...
                            .cornerRadius(15)
                            .foregroundStyle(Color(UIColor(resource: .CS_3)))
                    }
                }
