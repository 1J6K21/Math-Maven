...
// LessonImageGenerator.swift
// This file contains functions to generate lesson images for each problem type
...
func generateAllLessonImages() {
    ...
    let imagesDirectory = "\(currentDirectory)/Math Maven/generatedImages"
