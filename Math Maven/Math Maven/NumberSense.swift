...
struct NumberSense: View {
    ...
    private let questionFuncs: [() -> (String, Int, UIImage, Int)] = [IntegerSimplification,
                RemainderQuestion,
                RomanNumerals,
                TwoXtwo,
                OneHundreds,
                Squares,
                Cubes,
                DifferenceOfSquaresEndingIn5,
                AboveAndUnder50Squared,
                LCM,
                GCD,
                TriangularNumbers,
                TwoByTwoMultiplication,
                ImproperFractionMultiplication,
                IntegerSequenceSum,
                RootApproximation,
                PercentOfNumber,
                FractionToDecimal,
                ...
                TaxProblems,
                InvestmentProblems,
                SpecialDivisionTricks,
                SpecialAdditionSubtractionTricks,
                SumOfFactors,
                PerfectNumbers
            ]
    var body: some View{
