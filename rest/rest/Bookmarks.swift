...
struct Bookmarks: View {
    ...
    var body: some View {
        ...
        .onChange(of: UserDefaults.standard.array(forKey: "Bookmarks") as? [Int] ?? []) { oldValue, newValue in
            withAnimation{
...
public func getStrategy(id: Int) -> (String, UIImage){
    ...
    case 2:
        return("Remainders", UIImage(resource: .intSimplification))
    case 3:
        return("Roman Numeral Conversion", UIImage(resource: .intSimplification))
    case 4:
        return("Two by Two LOIF", UIImage(resource: .intSimplification))
    case 5:
        return("Multiply numbers near 100", UIImage(resource: .intSimplification))
    case 6:
        return("Squares", UIImage(resource: .intSimplification))
    case 7:
        return("Cubes", UIImage(resource: .intSimplification))
    case 8:
        return("Difference of Squares Ending in 5", UIImage(resource: .intSimplification))
    case 9:
        return("Squares near 50", UIImage(resource: .intSimplification))
    case 10:
        return("LCM", UIImage(resource: .intSimplification))
    case 11:
        return("GCD", UIImage(resource: .intSimplification))
    default:
        return("", UIImage())
    }
}
