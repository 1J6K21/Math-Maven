...
func RomanNumerals()->(String, Int, UIImage, Int){
    ...
    return (question, answerArabic, UIImage(resource: .intSimplification), 3)
...
func TwoXtwo()->(String, Int, UIImage, Int){
    ...
    return (question, answer, UIImage(resource: .intSimplification), 4)
}
...
func OneHundreds()->(String, Int, UIImage, Int){
    ...
    return (question, answer, UIImage(resource: .intSimplification), 5)
}
...
func DifferenceOfSquaresEndingIn5()->(String, Int, UIImage, Int){
    ...
    return (question, answer, UIImage(resource: .intSimplification), 8)
}
...
func AboveAndUnder50Squared()->(String, Int, UIImage, Int){
    ...
    return (question, answer, UIImage(resource: .intSimplification), 9)
}
...
func LCM()->(String, Int, UIImage, Int){
    ...
    return (question, answer, UIImage(resource: .intSimplification), 10)
}
...
func GCD()->(String, Int, UIImage, Int){
    ...
    return (question, answer, UIImage(resource: .intSimplification), 11)
}
